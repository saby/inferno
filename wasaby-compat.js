...
function replaceRequire(data) {
 ...
 function infernoDefineModuleCreate(what, data) {
     return `define('${what}', ['View/Executor/Expressions', 'Core/helpers/String/unEscapeASCII','Env/Env', 'UI/Utils'], function (Expressions, unEscapeASCII, Env, uiUtils) {var exports = {}, RawMarkupNode = Expressions.RawMarkupNode, Logger = uiUtils.Logger; ${data} return exports;});`;
 }
 function hydrateDefineModuleCreate(what, data) {
    return `define('${what}', ['View/Executor/Expressions', 'Core/helpers/String/unEscapeASCII','Env/Env', 'Inferno/third-party/index', 'UI/Utils'], function (Expressions, unEscapeASCII, Env, ${infernoVarName}, uiUtils) {var exports = {}, RawMarkupNode = Expressions.RawMarkupNode, Logger = uiUtils.Logger; ${replaceRequire(data)} return exports;});`;
}
 ...
 function copyData(pathToSave, sourcePath, amdName) {
  return function(savPath, srcPath, what) {
    ...
    if (what.indexOf('hydrate') !== -1) {
      src = hydrateDefineModuleCreate(what, srcContent);
    } else {
      src = infernoDefineModuleCreate(what, srcContent);
    }
