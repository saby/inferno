import { isFunction, isNull, isNullOrUndef, isString, isStringOrNumber, throwError, isArray } from 'inferno-shared';
...
function fixPortalChildrenForWasaby(vNode): VNode {
...
function mountPortal(vNode, context, parentDOM: Element | null, nextNode: Element | null, lifecycle: Function[]) {
  mount(fixPortalChildrenForWasaby(vNode), vNode.ref, context, false, null, lifecycle);
